...
def set_up_mediaeval2015():
    ...
    dataset_train = dataset.GraphDataset(df_train, config.root_dir, "imageId(s)", "tweetId",
                                config.me15_image_vec_dir, config.me15_text_vec_dir)
    
    dataset_test = dataset.GraphDataset(df_test, config.root_dir, "imageId(s)", "tweetId",
                                config.me15_image_vec_dir, config.me15_text_vec_dir)
